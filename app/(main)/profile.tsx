      ...
      >
        <View style={styles.avatarSection}>
          <View style={styles.avatar}>
            <Ionicons name="person" size={36} color={Colors.dark.accent} />
          </View>
          <Text style={styles.email}>{user?.email || "User"}</Text>
          <View style={styles.roleBadge}>
            <Text style={styles.roleText}>{user?.role === "admin" ? "Admin" : "Client"}</Text>
          </View>
        </View>
          ...
          >
            <View style={styles.menuLeft}>
              <View style={[styles.menuIcon, { backgroundColor: "rgba(212, 168, 83, 0.15)" }]}>
                <Ionicons name="sparkles-outline" size={20} color={Colors.dark.accent} />
              </View>
              <Text style={styles.menuLabel}>Browse Services</Text>
            </View>
            <Ionicons name="chevron-forward" size={20} color={Colors.dark.textSecondary} />
          </Pressable>
        </View>
